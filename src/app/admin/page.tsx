...
const AdminPage = () => {
  ...
  useEffect(() => {
    ...
    loadTimelineItems();
    loadCategories();
    loadContactVCard(); // إضافة تحميل بيانات بطاقة الاتصال
  }, []);
        ...
        <div className="mb-8">
          ...
          >
              ...
              <button 
                ...
                className={`px-4 py-2 rounded-lg transition-colors duration-300 ${activeTab === "mycard" ? "bg-blue-600" : "bg-gray-700 hover:bg-gray-600"}`}
              >
                <FaIdCard className="inline ml-2" /> بطاقتي
              </button>
            </div>
            </div>
              ...
              {contactVCardLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {/* الموقع الإلكتروني */}
                    <div>
                      <label htmlFor="contact-website" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        الموقع الإلكتروني
                      </label>
                      <input
                        type="url"
                        id="contact-website"
                        value={contactVCardData?.website || ""}
                        onChange={(e) => setContactVCardData(prev => prev ? { ...prev, website: e.target.value } : null)}
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                        placeholder="https://example.com"
                      />
                    </div>
                    ...
                    {/* العنوان */}
                    <div>
                      <label htmlFor="contact-address" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        العنوان
                      </label>
                      <textarea
                        id="contact-address"
                        value={contactVCardData?.address || ""}
                        onChange={(e) => setContactVCardData(prev => prev ? { ...prev, address: e.target.value } : null)}
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                  ...
                  <div className="space-y-4">
                    ...
                    {/* رقم الواتساب */}
                    <div>
                      <label htmlFor="contact-whatsapp" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        رقم الواتساب
                      </label>
                      <input
                        type="tel"
                        id="contact-whatsapp"
                        value={contactVCardData?.whatsapp || ""}
                        onChange={(e) => setContactVCardData(prev => prev ? { ...prev, whatsapp: e.target.value } : null)}
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                        placeholder="+xxxxxxxxxx"
                      />
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      {/* فيسبوك */}
                      <div className="flex items-center">
                        <span className="w-8 text-center text-blue-600">
                          <FaFacebookSquare />
                        </span>
                        <input
                          type="url"
                          value={contactVCardData?.socialMedia?.facebook || ""}
                          onChange={(e) => setContactVCardData(prev => {
                            if (!prev) return prev;
                            return {
                              ...prev,
                              socialMedia: {
                      ...
                      {/* تويتر */}
                      <div className="flex items-center">
                        <span className="w-8 text-center text-blue-400">
                          <FaTwitterSquare />
                        </span>
                        <input
                          type="url"
                          value={contactVCardData?.socialMedia?.twitter || ""}
                          onChange={(e) => setContactVCardData(prev => {
                            if (!prev) return prev;
                            return {
                              ...prev,
                      ...
                      {/* انستجرام */}
                      <div className="flex items-center">
                        <span className="w-8 text-center text-pink-600">
                          <FaInstagram />
                        </span>
                        <input
                          type="url"
                          value={contactVCardData?.socialMedia?.instagram || ""}
                          onChange={(e) => setContactVCardData(prev => {
                            if (!prev) return prev;
                            return {
                              ...prev,
                      ...
                      {/* لينكد إن */}
                      <div className="flex items-center">
                        <span className="w-8 text-center text-blue-700">
                          <FaLinkedin />
                        </span>
                        <input
                          type="url"
                          value={contactVCardData?.socialMedia?.linkedin || ""}
                          onChange={(e) => setContactVCardData(prev => {
                            if (!prev) return prev;
                            return {
                              ...prev,
                      ...
                      <div className="flex items-center">
                        ...
                        <input
                          type="url"
                          value={contactVCardData?.socialMedia?.youtube || ""}
                          onChange={(e) => setContactVCardData(prev => {
                            if (!prev) return prev;
                            return {
                              ...prev,
